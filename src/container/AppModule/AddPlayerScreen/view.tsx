...
//         leagueTeams.map(async (item, index) => {
//             const response: AxiosResponse<LeaguePlayerTypes[]> = await axios.get(`https://api.sportsdata.io/v3/nfl/projections/json/PlayerSeasonProjectionStatsByTeam/2021/${item}`, {
//                 headers: {
